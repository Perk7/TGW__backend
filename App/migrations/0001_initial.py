# Generated by Django 3.2.8 on 2021-12-22 14:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('government', models.CharField(default='m,t,a', max_length=5)),
                ...
                ('tax_physic', models.CharField(default='d z', max_length=11)),
                ('tax_jurid', models.CharField(default='p i g e', max_length=22)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kazna', models.IntegerField(default=10000000)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('con_type', models.CharField(choices=[('AL', 'Alliance'), ('CM', 'Common market'), ('PA', 'Passage of army'), ('CT', 'Culture transfer'), ('SH', 'Social help'), ('EH', 'Economic help'), ('CP', 'Contract of Peace'), ('ES', 'Economic sanctions'), ('DW', 'Declare war'), ('FW', 'Finish war'), ('VC', 'Vassal country')], default='EH', max_length=2)),
                ('priority', models.CharField(default='', max_length=30)),
                ('occuped', models.TextField(blank=True, default='')),
                ('spends', models.CharField(default='0_0', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buffs', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='App.countrybonus')),
